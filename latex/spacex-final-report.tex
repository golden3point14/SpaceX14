...
\begin{table}[H]
  ...
  \end{center}
  \vspace{-1em}
  \caption{Print event data format}
\end{table}
  ...
  \begin{center}
    \begin{tabular}{p{0.2\linewidth}p{0.7\linewidth}}
     \toprule
      ...
      \midrule
      \multirow{2}{*}Load File       & \texttt{assets/js/loadFile.js}\\
      ...
      \multirow{2}{*}Task State      & \texttt{assets/js/process.js}\\
      \multirow{2}{*}Task Compare    & \texttt{assets/js/compare.js}\\
    \bottomrule
    \end{tabular}
  \end{center}
  \vspace{-1em}
