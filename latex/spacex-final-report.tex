...
the application can be repackaged with following these steps.
...
\begin{enumerate}
  ...
  \item run \texttt{zip -r ../\${PWD\#\#*/}.nw *} here, which will create a file
  ...
  \item Move to this directory and run \texttt{cat nw SpaceX14.nw >
    app \&\& chmod +x app}
