...
\section{Architecture} % Wendy
  ...
  Trace-cmd Data is collected by using a command-line utility called trace-cmd.
  ...
  Parser Next the parser takes in this raw data, and ultimately outputs the data
  ...
  IndexedDB The application takes the JSON string and loads it into IndexedDB, a
  ...
  Local Storage Our application also makes use of Local Storage, another tool
  ...
  Overall Application Structure The general structure of our code is similar to
  ...
  Primary Javascript/CSS files One of the primary Javascript files we've worked
