...
Additionally, KernelShark has a poorly designed UI that does not function as
...
with hundreds of tasks to find the specific task they want. Additonally, zooming out on
...
\section{Architecture} % Wendy
  ...
  piece flows into the others, coming together to make our final tool.}
\end{center}
\end{figure}
