...
\section{SpaceShark}
\subsection{Design}
\subsection{Architecture} % Wendy
\subsection{Parser} % Wendy

\section{User Feedback} % Alix
\subsection{General Feedback} % Alix
\subsection{Feedback on Specific Pages} % Alix
