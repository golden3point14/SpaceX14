...
We only want to display two CPU graphs at a time on the Cycles page so that both graphs can be clearly visible. In the case that we have more than two CPUs, 
